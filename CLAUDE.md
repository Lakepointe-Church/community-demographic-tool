...
| `/methodology` | ✅ | Static data dictionary: every source (incl. Phase 4 LODES commute §5.4 / IRS SOI giving §5.5 / HUD address momentum §5.6), SES scoring, YFI/WFI weights, Site Scorer signals (7 toggleable: 6 on by default + Distance) + normalization formulas, leading-indicators section, church saturation index, ASARB methodology, per-metric definitions, known limitations |
